...
I am John Uwaishe from Abuja, Nigeria.

I am a driven software developer with a demonstrated history in developing software using
monolithic and microservices architectures. Experienced in object-oriented programming, developing, testing, and debugging code.
Administering systems and networks with success working in both team and self-directed settings.
